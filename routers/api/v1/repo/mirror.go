...
func MirrorSync(ctx *context.APIContext) {
	// POST /repos/{owner}/{repo}/mirror-sync repository repoMirrorSync
	// ---
...
func PushMirrorSync(ctx *context.APIContext) {
	// POST /repos/{owner}/{repo}/push_mirrors-sync repository repoPushMirrorSync
	// ---
...
func ListPushMirrors(ctx *context.APIContext) {
	// GET /repos/{owner}/{repo}/push_mirrors repository repoListPushMirrors
	// ---
...
func GetPushMirrorByName(ctx *context.APIContext) {
	// GET /repos/{owner}/{repo}/push_mirrors/{name} repository repoGetPushMirrorByRemoteName
	// ---
...
func AddPushMirror(ctx *context.APIContext) {
	// POST /repos/{owner}/{repo}/push_mirrors repository repoAddPushMirror
	// ---
...
func DeletePushMirrorByRemoteName(ctx *context.APIContext) {
	// DELETE /repos/{owner}/{repo}/push_mirrors/{name} repository repoDeletePushMirror
	// ---
