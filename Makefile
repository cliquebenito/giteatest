...
GO_LICENSES_REPORTS_DIR_SBT := reports
GO_LICENSES_REPORTS_FILE_SBT := licenses-report.json
GO_LICENSES_REPORTS_TEMPLATE_SBT := licenses-json.tpl
GO_LICENSES_REPORTS_LOG_SBT := licenses-errors.log
...
BACKUP_BINARY_NAME = sc-gitaly-backup
...
help:
	...
	@echo " - test-backend-correct             test correct backend files"
	...
	@echo " - sbt-licenses-report              generate sbt licenses report"
...
.PHONY: test-backend-correct
test-backend-correct:
	@echo "Running go test with -tags=correct"
	@$(GO) test ./... -v -tags=correct || exit 1
...
sbt-licenses-report:
	-$(GO) run $(GO_LICENSES_PACKAGE) report . --template $(GO_LICENSES_REPORTS_DIR_SBT)/$(GO_LICENSES_REPORTS_TEMPLATE_SBT) > $(GO_LICENSES_REPORTS_DIR_SBT)/$(GO_LICENSES_REPORTS_FILE_SBT) --ignore github.com/xi2/xz --ignore github.com/mrjones/oauth 2> $(GO_LICENSES_REPORTS_DIR_SBT)/$(GO_LICENSES_REPORTS_LOG_SBT)
...
generate-go: $(TAGS_PREREQ)
	...
	@CC= GOOS= GOARCH= $(GO) build -o ${BACKUP_BINARY_NAME} cmd/${BACKUP_BINARY_NAME}/*
