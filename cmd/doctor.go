...
var CmdDoctor = cli.Command{
	...
	Description: "A command to diagnose problems with the current SourceControl instance according to the given configuration. Some problems can optionally be fixed by modifying the database or data storage.",
	Action:      runDoctor,
	Flags: []cli.Flag{
		cli.BoolFlag{
			Name:  "list",
...
var cmdRecreateTable = cli.Command{
	...
	Description: `The database definitions SourceControl uses change across versions, sometimes changing default values and leaving old unused columns.
