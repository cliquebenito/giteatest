...
func Deliver(ctx context.Context, t *webhook_model.HookTask) error {
	...
	req.Header["X-SourceControl-Delivery"] = []string{t.UUID}
	req.Header["X-SourceControl-Event"] = []string{event}
	req.Header["X-SourceControl-Event-Type"] = []string{eventType}
	req.Header["X-SourceControl-Signature"] = []string{signatureSHA256}
