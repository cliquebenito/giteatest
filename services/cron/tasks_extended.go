...
func initExtendedTasks() {
	...
	if setting.TaskTracker.Enabled {
		registerUnitLinksSender()
	}
	if setting.CodeHub.CodeHubMetricEnabled {
		registerCodeHubCounterTasksProcessor()
		registerCodeHubCounterStatsProcessor()
	}
}
