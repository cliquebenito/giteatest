...
func TestCreateUser(t *testing.T) {
	user := &user_model.User{
		Name:               "SourceControlBot",
		Email:              "SourceControlBot@sourcecontrol.sbertech.ru",
		Passwd:             ";p['////..-++']",
		IsAdmin:            false,
...
func TestCreateUser_Issue5882(t *testing.T) {
	...
	tt := []struct {
		...
		{&user_model.User{Name: "SourceControlBot", Email: "SourceControlBot@sourcecontrol.sbertech.ru", Passwd: passwd, MustChangePassword: false}, false},
		{&user_model.User{Name: "SourceControlBot2", Email: "SourceControlBot2@sourcecontrol.sbertech.ru", Passwd: passwd, MustChangePassword: false}, true},
	}
