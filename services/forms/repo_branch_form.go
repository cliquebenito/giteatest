...
type NewBranchForm struct {
	NewBranchName string `binding:"Required;SbtMaxSize(100);SbtGitRefName"`
	CurrentPath   string
	CreateTag     bool
}
...
type RenameBranchForm struct {
	From string `binding:"Required;SbtMaxSize(100);SbtGitRefName"`
	To   string `binding:"Required;SbtMaxSize(100);SbtGitRefName"`
}
