...
<body>
	...
	<p>
		---
		<br>
		<a href="{{.Link}}">View it on SourceControl</a>.
	</p>
</body>
</html>
`
...
func TestGenerateAdditionalHeaders(t *testing.T) {
	...
	expected := map[string]string{
		...
		"X-SourceControl-Reason":            "dummy-reason",
		"X-SourceControl-Sender":            "< U<se>r Tw<o > ><",
		"X-SourceControl-Recipient":         "Test",
		"X-SourceControl-Recipient-Address": "test@gitea.com",
		"X-SourceControl-Repository":        "repo1",
		"X-SourceControl-Repository-Path":   "user2/repo1",
		"X-SourceControl-Repository-Link":   "https://try.gitea.io/user2/repo1",
		"X-SourceControl-Issue-ID":          "1",
		"X-SourceControl-Issue-Link":        "https://try.gitea.io/user2/repo1/issues/1",
	}
