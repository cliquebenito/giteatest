...
func (opts *SearchUserOptions) toSearchQueryBase() *xorm.Session {
	...
	// filter TenantWithRoleModeEnabled = true и массиву userIDs
	if setting.SourceControl.TenantWithRoleModeEnabled && !opts.IsAminPanel && len(opts.UserIDs) > 0 {
		cond = cond.And(builder.In("id", opts.UserIDs))
	} else if opts.UID > 0 && !setting.SourceControl.TenantWithRoleModeEnabled {
