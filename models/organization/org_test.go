...
func TestIsErrLastOrgOwner_ShouldBeFalse(t *testing.T) {
	got := organization.IsErrLastOrgOwner(errors.New("test"))

	assert.False(t, got)
}

func TestIsErrLastOrgOwner_ShouldBeTrue(t *testing.T) {
	got := organization.IsErrLastOrgOwner(&organization.ErrLastOrgOwner{UID: 4})
