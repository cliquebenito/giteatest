...
func (l *XORMLogBridge) Debug(v ...interface{}) {
	l.Log(stackLevel, log.DEBUG, prefix, fmt.Sprint(v...))
}

// Debugf show debug log
func (l *XORMLogBridge) Debugf(format string, v ...interface{}) {
	l.Log(stackLevel, log.DEBUG, fmt.Sprintf("%s %s", prefix, format), v...)
}

// Error show error log
func (l *XORMLogBridge) Error(v ...interface{}) {
	l.Log(stackLevel, log.ERROR, prefix, fmt.Sprint(v...))
}

// Errorf show error log
func (l *XORMLogBridge) Errorf(format string, v ...interface{}) {
	l.Log(stackLevel, log.ERROR, fmt.Sprintf("%s %s", prefix, format), v...)
}

// Info show information level log
func (l *XORMLogBridge) Info(v ...interface{}) {
	l.Log(stackLevel, log.INFO, "%s", fmt.Sprintf("%s", prefix), fmt.Sprint(v...))
}

// Infof show information level log
func (l *XORMLogBridge) Infof(format string, v ...interface{}) {
	l.Log(stackLevel, log.INFO, fmt.Sprintf("%s %s", prefix, format), v...)
}

// Warn show warning log
func (l *XORMLogBridge) Warn(v ...interface{}) {
	l.Log(stackLevel, log.WARN, prefix, fmt.Sprint(v...))
}

// Warnf show warnning log
func (l *XORMLogBridge) Warnf(format string, v ...interface{}) {
	l.Log(stackLevel, log.WARN, fmt.Sprintf("%s %s", prefix, format), v...)
}
