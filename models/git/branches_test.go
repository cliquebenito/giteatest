...
func TestRenameBranch(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.NoError(t, git_model.UpdateProtectBranch(ctx, repo1, &protected_branch.ProtectedBranch{
		RepoID:   repo1.ID,
		RuleName: "master",
	...
	unittest.AssertExistsAndLoadBean(t, &protected_branch.ProtectedBranch{
		RepoID:   repo1.ID,
		RuleName: "main",
	})
}
