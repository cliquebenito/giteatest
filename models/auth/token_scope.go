...
const (
	...
	AccessTokenScopeAdminPrivileges AccessTokenScope = "admin:privileges"
	AccessTokenScopeWritePrivileges AccessTokenScope = "write:privileges"
	AccessTokenScopeReadPrivileges  AccessTokenScope = "read:privileges"

	AccessTokenScopeProject      AccessTokenScope = "project"
	AccessTokenScopeWriteProject AccessTokenScope = "write:project"
	AccessTokenScopeReadProject  AccessTokenScope = "read:project"

	AccessTokenScopeTenant      AccessTokenScope = "tenant"
	AccessTokenScopeWriteTenant AccessTokenScope = "write:tenant"
	AccessTokenScopeReadTenant  AccessTokenScope = "read:tenant"

	AccessTokenScopeCodeHub AccessTokenScope = "codehub"
...
const (
	...
	AccessTokenScopeAllBits AccessTokenScopeBitmap = AccessTokenScopeRepoBits |
		...
		AccessTokenScopePackageBits | AccessTokenScopeAdminGPGKeyBits | AccessTokenScopeAdminApplicationBits | AccessTokenScopeAdminPrivilegesBits | AccessTokenScopeProjectBits |
		AccessTokenScopeTenantBits | AccessTokenScopeCodeHubBits
	...
	AccessTokenScopeAdminPrivilegesBits AccessTokenScopeBitmap = 1<<iota | AccessTokenScopeWritePrivilegesBits
	AccessTokenScopeWritePrivilegesBits AccessTokenScopeBitmap = 1<<iota | AccessTokenScopeReadPrivilegesBits
	AccessTokenScopeReadPrivilegesBits  AccessTokenScopeBitmap = 1 << iota

	AccessTokenScopeProjectBits      AccessTokenScopeBitmap = 1<<iota | AccessTokenScopeWriteProjectBits
	...
	AccessTokenScopeTenantBits      AccessTokenScopeBitmap = 1<<iota | AccessTokenScopeWriteTenantBits
	AccessTokenScopeWriteTenantBits AccessTokenScopeBitmap = 1<<iota | AccessTokenScopeReadTenantBits
	AccessTokenScopeReadTenantBits  AccessTokenScopeBitmap = 1 << iota

	AccessTokenScopeCodeHubBits AccessTokenScopeBitmap = 1 << iota
...
var allAccessTokenScopes = []AccessTokenScope{
	...
	AccessTokenScopeAdminPrivileges, AccessTokenScopeWritePrivileges, AccessTokenScopeReadPrivileges,
	AccessTokenScopeProject, AccessTokenScopeWriteProject, AccessTokenScopeReadProject,
	AccessTokenScopeTenant, AccessTokenScopeWriteTenant, AccessTokenScopeReadTenant,
	AccessTokenScopeCodeHub,
...
var allAccessTokenScopeBits = map[AccessTokenScope]AccessTokenScopeBitmap{
	...
	AccessTokenScopeAdminPrivileges:  AccessTokenScopeAdminPrivilegesBits,
	AccessTokenScopeWritePrivileges:  AccessTokenScopeWritePrivilegesBits,
	AccessTokenScopeReadPrivileges:   AccessTokenScopeReadPrivilegesBits,
	AccessTokenScopeProject:          AccessTokenScopeProjectBits,
	AccessTokenScopeWriteProject:     AccessTokenScopeWriteProjectBits,
	AccessTokenScopeReadProject:      AccessTokenScopeReadProjectBits,
	AccessTokenScopeTenant:           AccessTokenScopeTenantBits,
	AccessTokenScopeWriteTenant:      AccessTokenScopeWriteTenantBits,
	AccessTokenScopeReadTenant:       AccessTokenScopeReadTenantBits,
	AccessTokenScopeCodeHub:          AccessTokenScopeCodeHubBits,
...
func (bitmap AccessTokenScopeBitmap) ToScope() AccessTokenScope {
	...
	scope = AccessTokenScope(strings.ReplaceAll(
		string(scope),
		"repo,admin:org,admin:public_key,admin:org_hook,admin:user_hook,notification,user,delete_repo,package,admin:gpg_key,admin:application,admin:privileges,project,tenant,codehub",
		"all",
	))
	return scope
}
