...
func TestAPIGetWikiPage(t *testing.T) {
	...
	urlStr := fmt.Sprintf("/api/v1/repos/%s/%s/wiki/page/HomeOrg", username, "repo1")
...
func TestAPIListPageRevisions(t *testing.T) {
	...
	urlStr := fmt.Sprintf("/api/v1/repos/%s/%s/wiki/revisions/HomeOrg", username, "repo1")
