						...
						for {
							...
							for {
								...
								if hd.Name == "APKINDEX" {
									...
									assert.Contains(t, s, "T:SourceControl Test Package\n")
									assert.Contains(t, s, "U:https://sourcecontrol.sbertech.ru/\n")
									assert.Contains(t, s, "L:MIT\n")
									assert.Contains(t, s, "S:1353\n")
									assert.Contains(t, s, "I:4096\n")
									assert.Contains(t, s, "o:gitea-test\n")
									assert.Contains(t, s, "m:KN4CK3R <kn4ck3r@sourcecontrol.sbertech.ru>\n")
