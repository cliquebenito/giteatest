...
func testMirrorPush(t *testing.T, u *url.URL) {
	...
	srcGitRepo, err := git.OpenRepository(git.DefaultContext, srcRepo.OwnerName, srcRepo.Name, srcRepo.RepoPath())
	assert.NoError(t, err)
	...
	mirrorGitRepo, err := git.OpenRepository(git.DefaultContext, mirrorRepo.OwnerName, mirrorRepo.Name, mirrorRepo.RepoPath())
	assert.NoError(t, err)
