...
import octiconChevronUp from "../../public/img/svg/octicon-chevron-up.svg";
...
import octiconXCircle from '../../public/img/svg/octicon-x-circle.svg';
import octiconAlert from '../../public/img/svg/octicon-alert.svg';
import octiconHistory from '../../public/img/svg/octicon-history.svg';
import sonarCubeLogo from '../../public/img/svg/sonar-cube-logo.svg';
import octiconPencil from '../../public/img/svg/octicon-pencil.svg';
import octiconTrash from '../../public/img/svg/octicon-trash.svg';
import crown from '../../public/img/svg/crown.svg';
import octiconGear from '../../public/img/svg/octicon-gear.svg';
import octiconDotsCircle from '../../public/img/svg/octicon-dots-circle.svg';
import octiconCheckCircle from '../../public/img/svg/octicon-check-circle.svg';
import priorityMajor from '../../public/img/svg/priority-major.svg';
import priorityNormal from '../../public/img/svg/priority-normal.svg';
import priorityMinor from '../../public/img/svg/priority-minor.svg';

import scFileDiff from '../../public/img/svg/sc-file-diff.svg';
import scFilePlus from '../../public/img/svg/sc-file-plus.svg';
import scFileMinus from '../../public/img/svg/sc-file-minus.svg';

import licenseIcon from '../../public/img/svg/license.svg';
import noUsers from '../../public/img/svg/no-users.svg';
import noTeam from "../../public/img/svg/noTeam.svg";
import noMembers from "../../public/img/svg/no-members.svg";
import users from "../../public/img/svg/users.svg";
import repoBook from "../../public/img/svg/repo-book.svg";
import scFolder from '../../public/img/svg/sc-folder.svg';
import copy from '../../public/img/svg/copy-icon.svg';
import codehubForkRepo from '../../public/img/svg/codehub-fork-repo.svg';
...
const svgs = {
  ...
  'sonar-cube-logo': sonarCubeLogo,
  'octicon-pencil': octiconPencil,
  'octicon-trash': octiconTrash,
  'octicon-check-circle': octiconCheckCircle,
  'octicon-dots-circle': octiconDotsCircle,
  'octicon-gear': octiconGear,
  crown,
  'license': licenseIcon,
  'no-users': noUsers,
  'priority-major': priorityMajor,
  'priority-normal': priorityNormal,
  'priority-minor': priorityMinor,
  'sc-file-diff': scFileDiff,
  'sc-file-plus': scFilePlus,
  noTeam: noTeam,
  "no-members": noMembers,
  users: users,
  "repo-book": repoBook,
  'sc-file-minus': scFileMinus,
  'sc-folder': scFolder,
  'copy-icon': copy,
  'codehub-fork-repo': codehubForkRepo,
};
