...
export function initGlobalCommon() {
  ...
  $('.sc-tabs-nav .sc-tabs-nav__item').tab();
...
export function initGlobalButtons() {
  ...
  $(document).on('click', 'form button.cancel.button', (e) => {
    e.preventDefault();
  });

  $('.show-panel.sc-button, .show-panel').on('click', function (e) {
  ...
  $('.hide-panel.sc-button, .hide-panel').on('click', function (e) {
