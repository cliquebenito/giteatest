...
// NotifyPullRequestRebuild places a place holder function
func (*NullNotifier) NotifyPullRequestRebuild(ctx context.Context, doer *user_model.User, issue *issues_model.Issue, remoteAddress string) {
}
