...
const (
	...
	packageProjectURL  = "https://sourcecontrol.sbertech.ru"
	packageMaintainer  = "KN4CK3R <dummy@sourcecontrol.sbertech.ru>"
)
...
packager = SourceControl <pack@ag.er>
size = 123456
arch = aarch64
origin = origin
...
func TestParsePackageInfo(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		assert.Equal(t, "SourceControl <pack@ag.er>", p.FileMetadata.Packager)
