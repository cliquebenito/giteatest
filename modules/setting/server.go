...
var (
	...
	HttpRequestTimeout         = 600 * time.Second
...
func loadServerFrom(rootCfg ConfigProvider) {
	...
	AppName = rootCfg.Section("").Key("APP_NAME").MustString("SourceControl")
	...
	HttpRequestTimeout = sec.Key("HTTP_REQUEST_TIMEOUT").MustDuration(HttpRequestTimeout)
