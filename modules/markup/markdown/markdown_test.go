...
func TestRender_Images(t *testing.T) {
	...
	title := "Train"
	href := "https://sourcecontrol.sbertech.ru"
...
func TestRenderEmojiInLinks_Issue12331(t *testing.T) {
	testcase := `[Link with emoji :moon: in text](https://sourcecontrol.sbertech.ru)`
	expected := `<p><a href="https://sourcecontrol.sbertech.ru" rel="nofollow">Link with emoji <span class="emoji" aria-label="waxing gibbous moon">🌔</span> in text</a></p>
`
