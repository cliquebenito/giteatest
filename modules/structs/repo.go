...
type CreateRepoOption struct {
	...
	DefaultBranch string `json:"default_branch" binding:"SbtGitRefName;SbtMaxSize(100)"`
...
type EditRepoOption struct {
	// name of the repository. Cannot a change in version with Gitaly
	// deprecated: true
	// unique: true
	...
	// swagger:ignore
	MirrorInterval *string `json:"mirror_interval,omitempty" swaggerignore:"true"`
...
type CreateBranchRepoOption struct {
	...
	//
	// unique: true
	OldBranchName string `json:"old_branch_name" binding:"SbtGitRefName;SbtMaxSize(100)"`
