...
const (
	EnvRepoName      = "SC_REPO_NAME"
	EnvRepoUsername  = "SC_REPO_USER_NAME"
	EnvRepoID        = "SC_REPO_ID"
	EnvRepoIsWiki    = "SC_REPO_IS_WIKI"
	EnvPusherName    = "SC_PUSHER_NAME"
	EnvPusherEmail   = "SC_PUSHER_EMAIL"
	EnvPusherID      = "SC_PUSHER_ID"
	EnvKeyID         = "SC_KEY_ID" // public key ID
	EnvDeployKeyID   = "SC_DEPLOY_KEY_ID"
	EnvPRID          = "SC_PR_ID"
	EnvIsInternal    = "SC_INTERNAL_PUSH"
	EnvAppURL        = "SC_ROOT_URL"
	EnvActionPerm    = "SC_ACTION_PERM"
	EnvOldBranchName = "SC_OLD_BRANCH_NAME"
)
...
func FullPushingEnvironment(author, committer *user_model.User, repo *repo_model.Repository, repoName string, prID int64) []string {
	...
	environ := append(os.Environ(),
		...
		"SSH_ORIGINAL_COMMAND=sc-internal",
	)
